...
def sort_key(d:dict) -> str:
    return d['country'] # for sorting on line 108
...
with open(filename, 'w', encoding='utf-8', newline='') as output_file:
    ...
    # extrasaction="ignore" ignores two erros and removes the ranking
    writer.writeheader()
    # for row in medals_table:
    #     writer.writerow(row) #gives the same output as the one under need
